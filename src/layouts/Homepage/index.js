...
const segments = ["home", "work", "team", "honors", "contact"];
...
class Homepage extends Component {
  smoothScrollTo = (target, immediate) => {
    ...
    if (immediate) {
      ...
      smoothscroll(offset, 300, () => {}, this.scrollContext);
    }
  };
  ...
  render() {
    ...
    return (
      ...
      >
        <section
          className={styles.homepageSegments}
          ref={e => (this.scrollContext = e)}
        >
          {this.helmet()}
            ...
            <section className={styles.teamWrapper}>
              <section className={styles.teamDescription}>
                <h2 className={styles.teamExperience}>
                  A crack crew of IT Veterans, armed with{" "}
                  <strong className={styles.parsecs}>7.34 parsecs</strong> of
                  experience.
                </h2>
              </section>
              <Teammates />
              <p className={styles.teamValues}>
                We believe in using <strong>the right tools</strong>,{" "}
                <strong>consistent shipping</strong> of{" "}
                <strong>quality results</strong> and{" "}
                <strong>crystal clear communication</strong> to get the job
                done. We put <strong>laser focus on project success</strong>. We
                thrive <strong>on the unknown</strong>.
              </p>
            </section>
          </section>
          <section id="work" ref={setRefById}>
            ...
            <p>
              We are experienced in flying solo as well as supporting large
              teams. We've worked with high-profile brands as well as budding
              startups and our prototypes have travelled the globe alongside
              prominent expos.
            </p>
            <p>
              We love what we do, hence we are driven to experiment and embrace
              new technologies. However{" "}
              <strong>what we value the most is your success</strong>. That's
              why focus on a core set of tools which we know back to back.
            </p>
            <p className={styles.blogLink}>
              <Link to="/blog">
                We share our insights and discoveries on our blog.
              </Link>
            </p>
            <Technologies />
          </section>
          ...
          <section id="contact" className={styles.contact} ref={setRefById}>
            ...
            <h2>Interested? We'd love to touch base.</h2>
            <h3>
              <a href="mailto:korneliusz@makersden.io">Send us an email</a> or
              drop a line in the chatbox.
            </h3>
          </section>
          <HelpChat />
        </section>
